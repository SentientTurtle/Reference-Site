    ...
    protected HTML[] getContent(HtmlContext context) {
        ...
        if (typeEffects.contains(11)) {
            table.content(TR().content(TD().content(
                SPAN("module_fitting_span").content(
                    IMG(Resource.ofIconID(295, context), null, 32).className("module_fitting_icon"),
                    TEXT("Low power slot")
                )
            )));
            ...
            row.content(TD().content(
                SPAN("module_fitting_span").content(
                    IMG(Resource.ofIconID(293, context), null, 32).className("module_fitting_icon"),
            ...
            if (typeEffects.contains(42)) {
                row.content(TD().content(
                    SPAN("module_fitting_span").content(
                        IMG(Resource.ofIconID(387, context), null, 32).className("module_fitting_icon"),
                ...
                row.content(TD().content(
                    SPAN("module_fitting_span").content(
                        IMG(Resource.ofIconID(168, context), null, 32).className("module_fitting_icon"),
            ...
            table.content(TR().content(TD().content(
                SPAN("module_fitting_span").content(
                    IMG(Resource.ofIconID(294, context), null, 32).className("module_fitting_icon"),
            ...
            rigRow.content(TD().content(
                SPAN("module_fitting_span").content(
                    IMG(Resource.ofIconID(3266, context), null, 32).className("module_fitting_icon"),
        ...
        if (showPGCPU) {
            table.content(TR().content(
                TD().content(
                    SPAN("module_fitting_span").content(
                        IMG(Resource.ofIconID(1405, context), null, 32).className("module_fitting_icon"),
                        TEXT("CPU usage: "), context.sde.format_with_unit(cpuUsage, context.sde.getAttributes().get(50).unitID)
                    )
                ),
                TD().content(
                    SPAN("module_fitting_span").content(
                        IMG(Resource.ofIconID(1400, context), null, 32).className("module_fitting_icon"),
        ...
        if (activationCost > 0.0) {
            var row = TR().content(
                TD().content(
                    SPAN("module_fitting_span").content(
                        IMG(Resource.ofIconID(1668, context), null, 32).className("module_fitting_icon"),
        ...
        if (activationTime > 0.0) {
            var row = TR().content(
                TD().content(
                    SPAN("module_fitting_span").content(
                        IMG(Resource.ofIconID(1392, context), null, 32).className("module_fitting_icon"),
        ...
        if (type.groupID == 4086) {
            ...
            for (int id : structureID) {
                table.content(TR().content(
                    TD().content(
                        SPAN("module_fitting_span").content(
                            IMG(Resource.ofIconID(21729, context), null, 32).className("module_fitting_icon"),
